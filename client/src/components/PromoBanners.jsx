...
import BrandIndia from "./BrandIndia"
...
      <div
        className="relative overflow-hidden rounded-2xl shadow-lg w-full mx-auto group cursor-pointer"
        style={{
...
        {/* Banner Image */}
        <img
          src={currentBanner?.image?.url || "/placeholder.svg?height=280&width=1200&query=abstract category banner background"}
          alt={currentBanner?.title || "Promotional banner"}
          className="w-full h-36 sm:h-48 md:h-56 lg:h-80 xl:h-96 object-cover transition-transform duration-500 group-hover:scale-105"
        />
