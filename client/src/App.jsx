...
//   // Extract the ID from the old URL format
//   const productId = match.params.id;
  
//   // In a real app, you would fetch the product name here
//   // For now, we'll redirect to a placeholder slug
//   return <Navigate to={`/product/product-${productId}`} replace />;
// };
...
//             {/* NEW: Product routes with SEO-friendly URLs */}
//             <Route path="/product/:productSlug" element={<ProductDetailPage />} />
            
//             {/* OLD: Keep the old route for backward compatibility and redirect */}
//             <Route path="/product-old/:id" element={<ProductRedirect />} />
