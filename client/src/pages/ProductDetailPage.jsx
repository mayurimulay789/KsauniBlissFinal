...
const ProductDetailPage = () => {
  ...
  useEffect(() => {
    console.log(
      "ProductDetailPage useEffect triggered with id:",
      id,
      "and slug:",
      slug
    );
                    ...
                    <div className="absolute bottom-6 left-2 right-2 flex items-center justify-between gap-2">
                      ...
                      <div className="px-3 py-1  mx-4 rounded-full bg-black/80 text-white text-xs font-semibold flex items-center gap-2">
                        <span className="uppercase">
                          {currentProduct?.category?.name
                            ? String(currentProduct.category.name)
                            : "REGULAR"}
                        </span>
          ...
          <div className="space-y-1">
              ...
              <div className="flex items-center space-x-4">
                <div className="flex items-center border border-gray-300 rounded-xl overflow-hidden">
                  ...
                  <motion.button
                    ...
                    onClick={() =>
                      setQuantity(
                        Math.min(getSelectedSizeStock(), quantity + 1)
                      )
                    }
            ...
            <div className="mt-4 md:hidden">
              {currentProduct.productDetails && (
                <div className="pt-1">
                  <h2 className="text-md font-bold text-gray-700 mb-1">
                    Product Details
                  </h2>
              ...
              <div className="p-6">
                ...
                <div className="prose prose-sm max-w-none">
                  <p className="text-gray-600 mb-4">
                    Use this guide to help determine your correct size.
