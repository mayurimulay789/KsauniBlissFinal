            ...
            >
              ...
              <div className="mb-4 space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span
                    className={
                      currentOrder.pricing.shippingCharges === 0
                        ? "text-green-600"
                        : ""
                    }
                  >
                    {currentOrder.pricing.shippingCharges === 0
                      ? "FREE"
                      : `₹${currentOrder.pricing.shippingCharges}`}
                  </span>
                </div>
              ...
              <div className="p-3 rounded-lg bg-green-50">
                {currentOrder.paymentInfo?.paymentMethod === "COD" ? (
                  <p className="text-sm font-medium text-green-800">Payment Method: COD</p>
                ) : (
                  <>
                    <p className="text-sm font-medium text-green-800">Payment Successful</p>
                    <p className="text-xs text-green-600">Payment ID:{currentOrder.paymentInfo?.razorpayPaymentId || "N/A"}</p>
                  </>
                )}
              </div>
            </motion.div>
