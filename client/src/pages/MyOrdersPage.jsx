                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                      <div className="mb-4 sm:mb-0">
                        ...
                        <p className="text-sm text-gray-600">
                          Delivered to {order?.shippingAddress?.city || "N/A"},{" "}
        ...
        <Modal onClose={() => setShowCancelModal(false)}>
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              className="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-pink-500 focus:ring-2 focus:ring-pink-500"
              rows={3}
            />
          </div>
          <div className="flex space-x-3">
...
{/*             { selectedOrder.trackingUrl ? (
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Tracking will be available once your order has been shipped.
                </p>
              </div>
            )} */}
